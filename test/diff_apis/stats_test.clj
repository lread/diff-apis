...
(t/deftest arglists-test
  (t/is (= [{:type :namespaces :equal 1 :deleted 0 :inserted 0 :changed 0}
            {:type :publics    :equal 1 :deleted 0 :inserted 0 :changed 0}
            {:type :arglists   :equal 1 :deleted 0 :inserted 0 :changed 0} ]
  ...
  (t/is (= [{:type :namespaces :equal 1 :deleted 0 :inserted 0 :changed 0}
            {:type :publics    :equal 1 :deleted 0 :inserted 0 :changed 0}
            {:type :arglists   :equal 3 :deleted 0 :inserted 0 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
                                           :arglists '[[a b c] [d e] []]}]}])))

  (t/is (= [{:type :namespaces :equal 2 :deleted 0 :inserted 0 :changed 0}
            {:type :publics    :equal 2 :deleted 0 :inserted 0 :changed 0}
            {:type :arglists   :equal 5 :deleted 0 :inserted 0 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
                                           :arglists '[[a b c] [d e] []]}]}
                               {:name "ns2"
  ...
  (t/is (= [{:type :namespaces :equal 1 :deleted 0 :inserted 0 :changed 1}
            {:type :publics    :equal 1 :deleted 0 :inserted 0 :changed 1}
            {:type :arglists   :equal 2 :deleted 0 :inserted 3 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
  ...
  (t/is (= [{:type :namespaces :equal 0 :deleted 0 :inserted 0 :changed 2}
            {:type :publics    :equal 0 :deleted 0 :inserted 0 :changed 2}
            {:type :arglists   :equal 1 :deleted 1 :inserted 3 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
                                           :arglists (deep-diff/->Insertion ['[a b c] '[d e] '[]])}]}
                               {:name "ns2"
  ...
  (t/is (= [{:type :namespaces :equal 0 :deleted 0 :inserted 0 :changed 2}
            ...
            {:type :arglists   :equal 1 :deleted 4 :inserted 3 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
                                           :arglists (deep-diff/->Insertion ['[a b c] '[d e] '[]])}]}
                               {:name "ns2"
  ...
  (t/is (= [{:type :namespaces :equal 0 :deleted 0 :inserted 0 :changed 2}
            {:type :publics    :equal 0 :deleted 0 :inserted 0 :changed 3}
            {:type :arglists   :equal 0 :deleted 4 :inserted 3 :changed 1}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1"
                                           :arglists (deep-diff/->Insertion ['[a b c] '[d e] '[]])}]}
                               {:name "ns2"
...
(t/deftest publics-test
  (t/is (= [{:type :namespaces :equal 3 :deleted 0 :inserted 0 :changed 0}
            {:type :publics    :equal 4 :deleted 0 :inserted 0 :changed 0}
            {:type :arglists   :equal 0 :deleted 0 :inserted 0 :changed 0}]
           (stats/count-diffs [{:name "ns1"
                                :publics [{:name "p1-1"
                                           :type "var"}]}
                               {:name "ns2"
  ...
  (t/is (= [{:type :namespaces :equal 2 :deleted 0 :inserted 0 :changed 1}
  ...
  (t/is (= [{:type :namespaces :equal 1 :deleted 0 :inserted 0 :changed 2}
  ...
  (t/is (= [{:type :namespaces :equal 0 :deleted 0 :inserted 0 :changed 3}
