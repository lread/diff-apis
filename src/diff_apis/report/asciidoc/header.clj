...
(defn- diff-summary
  "Summarize diff without being to wordy"
  [projects]
  (let [a (:a projects)
        b (:b projects)]
    (str "Diff of " (:project a) " " (:version a)
         (when (not= (:lang a) (:lang b)) (str " " (:lang a)))
         " & "
         (when (not= (:project a) (:project b)) (str " " (:project b)))
         (when (not= (:version a) (:version b)) (str " " (:version b)))
         (when (not= (:lang a) (:lang b)) (str " " (:lang b))))))

(defn header-title [{:keys [projects]}]
  ["// This file was auto-generated by diff-apis, best not to edit"
   (str  "= " (render/escape-text (diff-summary projects)))
   ":toc: macro"
   ":toclevels: 5"
   ":!toc-title:"
   ""])
